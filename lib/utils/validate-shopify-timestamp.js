 ...
 * @return {boolean}
 * @example
 * const validTimestamp = validateShopifyTimestamp({ timestamp: '1533160800', margin: 60 * 5 });
 */
const validateShopifyTimestamp = ({ timestamp, margin = 60 }) => {
...
module.exports = validateShopifyTimestamp;
